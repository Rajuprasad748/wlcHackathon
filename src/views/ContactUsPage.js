...
const ContactUsPage = () => {
  ...
  const handleSubmit = () => {
    toast.success('Thnak You for your feedback!')
  }
  return (
    <div className="flex w-screen h-screen overflow-hidden">
      ...
      <section className="text-gray-600 body-font relative flex items-center justify-center w-full bg-slate-300 h-full">
        <div className="container px-5 py-10 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button onClick={handleSubmit} className="flex mx-auto text-white bg-[#1F2937] border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg active:scale-95">
                  Submit 
                </button>
              </div>
            </div>
